...
class Events extends Component {
  ...
  getRegStatus = () => {
    ...
    const status = eventsList.find(eachItem => eachItem.id === eventId)
    console.log(status)
    if (status) {
    ...
    return (
      <div className="bg-container">
        <div className="heading-container">
          ...
          <div className="event-rege-container">
            <ul className="events-container">
              {eventsList.map(eachEvent => (
                <EventItem
                  key={eachEvent.id}
                  isActive={eventId === eachEvent.id}
        ...
        <div className="registration-container">
          <ActiveEventRegistrationDetails regStatus={this.getRegStatus()} />
        </div>
      </div>
    )
  }
